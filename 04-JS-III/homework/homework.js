...
function dePalabrasAFrase(palabras) {
  ...
  {
    str = str + palabras[i];
    if(i < palabras.length - 1) str = str + ' ';
  }
  return str;
}
...
function mesesDelAño(array) {
  ...
  for(i = 0 ; i < 3 ; i++)
  {
    switch(i)
    {
      case 0: for(a = 0 ; a < array.length ; a++)
              {
                if(array[a] === 'Marzo')
                {
                  meses.push(array[a]);
      ...
      case 1: for(a = 0 ; a < array.length ; a++)
              {
      ...
      case 2: for(a = 0 ; a < array.length ; a++)
              {
                if(array[a] === 'Enero')
                {
                  meses.push(array[a]);
...
function mayorACien(array) {
  ...
  for(i = 0 ; i < array.length ; i++)
  {
    if(array[i] > 100) Centenarios.push(array[i]);
  }return Centenarios;
}
